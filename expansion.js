(() => {
  ...
  const npcs = [
    ...
    {id:"cartographer",name:"브론",role:"드워프 지도 제작자",text:"바위 위에 지도를 펼친 브론이 말한다. ‘길을 알려 줄 수도 있고, 위험한 곳을 표시해 줄 수도 있지.’",choices:[{label:"안전한 길을 묻는다",story:"브론의 안전한 길을 따르기로 했다.",recipe:"tortoiseBroth",xp:4},{label:"숨겨진 보물길을 택한다",story:"브론의 위험한 보물길을 택했다.",item:"slimeGel",xp:7}]},
